"""
Django settings for salvusbackend project.
...
ALLOWED_HOSTS = ['localhost', 'salvusbackend.herokuapp.com', 'https://salvusbackend-6f4cec5e1bd6.herokuapp.com/','127.0.0.1']
...
WSGI_APPLICATION = 'salvusbackend.wsgi.application'
